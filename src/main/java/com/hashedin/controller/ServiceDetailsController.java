...
public class ServiceDetailsController {
  ...
  public @ResponseBody List<Deployment> getHistory(@PathVariable Integer serviceId, @RequestParam(required = false) String env) {

   return serviceDeatilsService.getHistoryByEnv(serviceId,env);
  };
  }
